...
def _fill_trainval_infos(nusc, train_scenes, val_scenes, test=False, max_sweeps=10):
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        #print(lidar_token)
        scene_desc = nusc.get("scene", sample["scene_token"])["N"]+nusc.get("scene", sample["scene_token"])["R"]+nusc.get("scene", sample["scene_token"])["C"]
        #print("-----------DEBUG in nuscenes_converter.py----------------")
        #print("Scene Description", scene_desc)
        #print("lidarpath",lidar_path)
        try:
            ...
            if sample["scene_token"] in train_scenes:
                ...
                #print("Debug --- add a new train sample")
            elif sample["scene_token"] in val_scenes:
                val_nusc_infos.append(info)
                #print("Debug --- add a new val sample")
            #else:
            #    #print("Neither train nor val")
        except:
            pass
