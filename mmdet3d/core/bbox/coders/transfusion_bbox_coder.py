...
class TransFusionBBoxCoder(BaseBBoxCoder):
    ...
    def encode(self, dst_boxes):
        #print("------------------------DEBUG0 in transfusion_bbox_coder.py__________________")
        #print(dst_boxes)
        #print(len(dst_boxes[0]))
    ...
    def decode(self, heatmap, rot, dim, center, height, vel, filter=False):
        ...
        predictions_dicts = []
        #print("-----------------------DEBUG1 in transfusion_bbox_coder.py-----------------")
        ...
        if filter is False:
            #print("-----------------------DEBUG1.2 in transfusion_bbox_coder.py-----------------")
            #print(len(predictions_dicts))
        ...
        if self.post_center_range is not None:
            ...
            #print("-----------------------DEBUG2 in transfusion_bbox_coder.py-----------------")
            #print(len(predictions_dicts))  
        ...
        #print("-----------------------DEBUG3 in transfusion_bbox_coder.py-----------------")
        #print(len(predictions_dicts))
